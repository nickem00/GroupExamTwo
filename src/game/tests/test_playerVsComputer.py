...
class TestPlayerVsComputerClass(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertIsInstance(game.computer_player, intelligence.Intelligence)
    ...
    def test_option_one(
        self, mock_start_game, mock_print, mock_clear_screen, mock_input, mock_exit
    ):
    ...
    def test_option_two(
        self, mock_show_rules, mock_print, mock_clear_screen, mock_input, mock_exit
    ):
    ...
    @patch("tools.Tools.clear_screen")
    @patch("builtins.print")
    def test_option_three(self, mock_print, mock_clear_screen, mock_input, mock_exit):
    ...
    def test_option_four(
        self,
        mock_display_highscores,
    ...
    @patch("tools.Tools.clear_screen")
    @patch("builtins.print")
    def test_invalid_option(self, mock_print, mock_clear_screen, mock_input, mock_exit):
    ...
    @patch("builtins.print")
    @patch("time.sleep")
    def test_invalid_option_letter(
        self, mock_sleep, mock_print, mock_clear_screen, mock_input, mock_exit
    ):
    ...
    @patch("sys.exit", side_effect=MockExitException)
    def test_start_game(
        self, mock_exit, mock_enter_to_continue, mock_input, mock_print
    ):
    ...
    @patch("tools.Tools.clear_screen")
    @patch("tools.Tools.enter_to_continue")
    def test_human_players_turn_letter(
        self,
        mock_enter_to_continue,
        mock_clear_screen,
        mock_sleep,
    ...
    def test_human_players_turn_rolled_a_one(self, mock_input, mock_print):
        """
        Test the human_players_turn method of the PlayerVsComputer class,
    ...
    def test_human_players_turn_hold_not_winning(self, mock_input, mock_print):
        ...
        game_menu_options = {"1": ("Roll die", MagicMock()), "2": ("Hold", MagicMock())}
        game.human_players_turn(0, game_menu_options)
    ...
    def test_human_players_turn_developer_options(self, mock_input, mock_print):
        """
        Test the human_players_turn method of the PlayerVsComputer class,
    ...
    def test_human_players_turn_else(self, mock_input, mock_print):
        """
        Test the human_players_turn method of the PlayerVsComputer class,
    ...
    def test_human_players_turn_invalid(self, mock_input, mock_print):
        """
        Test the human_players_turn method of the PlayerVsComputer class,
    ...
    @patch("tools.Tools.enter_to_continue")
    def test_computer_players_turn(
        self, mock_enter_to_continue, mock_start_round, mock_print
    ):
        """
    ...
    def test_change_difficulty_same(self, mock_change_difficulty, mock_print):
        """
    ...
    def test_change_difficulty(self, mock_change_difficulty, mock_print):
        """
        Test the change_difficulty method of the PlayerVsComputer class,
