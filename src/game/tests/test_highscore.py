...
class TestHighscoreClass(unittest.TestCase):
    ...
    @patch(
        "builtins.open", new_callable=mock_open, read_data="player1: 50\nplayer2: 80"
    )
    ...
    @patch(
        "highscore.Highscore.read_highscores",
        return_value={"player1": 80, "player2": 50},
    )
    def test_display_highscores(
        self,
    ...
    def test_display_highscores_no_highscores(
        self, mock_read_highscores, mock_enter_to_continue, mock_print
    ):
    ...
    def test_save_new_highscore_no_new_highscore(
        self, mock_open, mock_read_highscores, mock_enter_to_continue, mock_print
    ):
        """
    ...
    @patch("builtins.open", new_callable=mock_open)
    def test_save_new_highscore_new_highscore(
        self, mock_open, mock_read_highscores, mock_enter_to_continue, mock_print
    ):
        """
    ...
    @patch("builtins.open", new_callable=mock_open)
    def test_save_new_highscore_new_player(
        self, mock_open, mock_read_highscores, mock_enter_to_continue, mock_print
    ):
        """
